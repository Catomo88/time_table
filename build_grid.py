...
WHO=["첫째","둘째"]
import os
S=[[d["who"],d["day"],d["s"],d["e"],d["title"],d["cat"],d.get("place",""),d.get("assumed",False),d.get("note","")] for d in json.load(open("schedule.json",encoding="utf-8"))]
...
open("_data.json","w",encoding="utf-8").write(json.dumps(data,ensure_ascii=False))
